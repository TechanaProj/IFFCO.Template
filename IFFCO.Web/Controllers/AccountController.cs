...
using IFFCO.NERRS.Web.Areas.M1.Controllers;
using IFFCO.HRMS.Entities.AppConfig;
using Devart.Data.Oracle;
using Microsoft.Extensions.Configuration;
using System.Net;

namespace IFFCO.NERRS.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IHttpContextAccessor accessor, IConfiguration config)
        {
